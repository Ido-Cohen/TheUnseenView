...
const FinalStep = ({ image }) => {
    ...
    const handleDownload = async () => {
        try {
            ...
            // Handle any errors
            toast.error('Error occurred during file download:', error);
                        ...
                        <div className="card-body">
                            ...
                            {downloadProgress > 0 && (
                                <div className="progress mt-3 h-25 mb-3">
                                    ...
                                    <div className="progress-bar" role="progressbar" style={{ width: `${downloadProgress}%` ,fontSize:'20px'}} aria-valuenow={downloadProgress} aria-valuemin="0" aria-valuemax="100">
